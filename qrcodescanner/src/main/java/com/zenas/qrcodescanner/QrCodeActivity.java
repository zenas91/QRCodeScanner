package com.zenas.qrcodescanner;
...
import com.zenas.qrcodescanner.camera.CameraManager;
import com.zenas.qrcodescanner.decode.CaptureActivityHandler;
import com.zenas.qrcodescanner.decode.DecodeImageCallback;
import com.zenas.qrcodescanner.decode.DecodeImageThread;
import com.zenas.qrcodescanner.decode.DecodeManager;
import com.zenas.qrcodescanner.decode.InactivityTimer;
import com.zenas.qrcodescanner.view.QrCodeFinderView;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private final String GOT_RESULT = "qr_scan_result";
    ...
    private DecodeImageCallback mDecodeImageCallback = new DecodeImageCallback() {
        ...
        public void decodeSucceed(Result result) {
            //Got scan result from scanning an image loaded by the user
